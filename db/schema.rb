...
ActiveRecord::Schema.define(version: 20_151_024_171_842) do
  ...
  add_index 'articles_users',
    ['article_id'],
    name: 'index_articles_users_on_article_id'
  add_index 'articles_users',
    ['user_id'],
    name: 'index_articles_users_on_user_id'
